...
class Mail:
    ...
    def send_assigin_mail_to_instructor(self, instructor_info, student_info):
        ...
        self.send(subject, content, instructor_info["mail"])
    ...
    def send_mail_accept_consultation_services(self, instructor_info, student_info):
        ...
        content = instructor_info["name"] + "様\n\n"\
            'いつもお世話になっております。\n'\
            'WorkReady運営です。\n\n'\
            'この度、ご担当頂いております' + student_info["name"] + "様より相談会をご予約いただきましたことをご連絡いたします。\n\n"\
            "■受講生氏名\n" + student_info["name"] +"\n\n"\
    ...
    def send(self, subject, content, mail):
        message = MIMEText(content)
        message['Subject'] = subject
        message['From'] = email.utils.formataddr(('Work Ready運営', self._source_address))
        message['To'] = mail
